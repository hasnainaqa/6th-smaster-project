...
export default function SideBar() {
    return (
       ...
       <div className="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style={{ width: '280px',  minHeight: '100vh', position: 'fixed' }}>
             <a className="navbar-brand d-flex align-items-center" style={{ fontSize: 16 }} href="#">
                        ...
                        <span className={styles.logo}>Feedback</span>
                        <span className={styles.logo} style={{ color: Colors.red }}>Fusion</span>
                    </a>
            <hr />
            <ul className="nav nav-pills flex-column mb-auto">
                <li className="nav-item">
                    <a href="#" className={`nav-link nav-link active ${styles.active_clr}`} aria-current="page">
            ...
            <div className="">
            <button type="button" className={`btn ${styles.cus_btn}`}>Sign out</button>
